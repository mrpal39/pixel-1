...
const CropPanel: React.FC<CropPanelProps> = ({ onApplyCrop, onSetAspect, isLoading, isCropping }) => {
  ...
  const aspects: { name: AspectRatio, value: number | undefined, tip: string }[] = [
    { name: 'free', value: undefined, tip: 'Freely select any aspect ratio.' },
    { name: '1:1', value: 1 / 1, tip: 'Constrain crop to a square aspect ratio.' },
    { name: '16:9', value: 16 / 9, tip: 'Constrain crop to a widescreen aspect ratio.' },
  ];
  ...
  return (
    <div className="w-full bg-gray-800/50 border border-gray-700 rounded-lg p-4 flex flex-col items-center gap-4 animate-fade-in backdrop-blur-sm">
      ...
      <Tooltip text="Confirm and apply the crop to the image.">
        <button
          onClick={onApplyCrop}
